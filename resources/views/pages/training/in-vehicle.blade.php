	...
	<div class="container">
		<div class="row">
			<div class="page-banner text-center col-xs-12">
				<h1>In-vehicle Monitoring Solution</h1>
				<ul>
					<li><a href="/">home</a></li>
					<li><span>Fire Safety Training & Solutions</span></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="section-title text-center col-xs-12 mb-45">
				<h3 class="heading">In-vehicle Monitoring Solution</h3>
				<div class="excerpt">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 col-xs-12">
				<div class="section-title text-center col-xs-12 mb-45">
				<h3 class="heading">Civil | In-vehicle Monitoring Solution in UAE</h3>
				<div class="excerpt">
					<p>Driving and Vocational Training Institute in UAE since 2007</p>
				</div>
				<i class="icofont icofont-traffic-light"></i>
