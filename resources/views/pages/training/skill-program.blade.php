...
<!-- Page Banner Area
============================================ -->
<div class="page-banner-area overlay overlay-black overlay-70 parallax-window" data-parallax="scroll" data-bleed="10" data-speed="0.5" data-image-src="img/section-bg/training-banner-2.jpg">
	<div class="container">
		<div class="row">
			<div class="page-banner text-center col-xs-12">
				<h1>Skill Learning & Development Programs</h1>
				<ul>
					<li><a href="/">home</a></li>
					<li><span>Skill Learning & Development Programs</span></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="section-title text-center col-xs-12 mb-45">
				<h3 class="heading">Skill Learning & Development Programs</h3>
				<div class="excerpt">
...
<!-- Demo Content Area
============================================ -->
<div class="demo-content bg-gray pt-90 pb-60">
	<div class="container">
		<!-- Section Title -->
		<div class="row">
			...
			<div class="col-sm-8 col-xs-12 mb-30">
				...
				<ul>
					<li>
						Est dolore amet consequat occaecat ut nostrud laborum mollit minim excepteur.
					</li>
					<li>
						Est dolore amet consequat occaecat ut nostrud laborum mollit minim excepteur.
					</li>
...
<!-- Testimonial Area
============================================ -->
<div id="testimonial-area" class="training-bottom-area overlay overlay-white overlay-80 text-center pt-100 pb-0">
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 col-xs-12">
				<div class="section-title text-center col-xs-12 mb-45">
				<h3 class="heading">Civil | Skill Learning & Development Programs in UAE</h3>
				<div class="excerpt">
					<p>Driving and Vocational Training Institute in UAE since 2007</p>
				</div>
				<i class="icofont icofont-traffic-light"></i>
					...
					<img src="img/general/Civil-Training.png" alt="" />
					<br><br><br>
