	...
	<div class="container">
		<div class="row">
			<div class="page-banner text-center col-xs-12">
				<h1>Safety & Security Solutions</h1>
				<ul>
					<li><a href="/">home</a></li>
					<li><span>Safety & Security Solutions</span></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="section-title text-center col-xs-12 mb-45">
				<h3 class="heading">Safety & Security Solutions</h3>
				<div class="excerpt">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2 col-xs-12">
				<div class="section-title text-center col-xs-12 mb-45">
				<h3 class="heading">Civil | Safety & Security Solutions in UAE</h3>
				<div class="excerpt">
					<p>Driving and Vocational Training Institute in UAE since 2007</p>
				</div>
				<i class="icofont icofont-traffic-light"></i>
