...
@section('content')
 <div class="content-inner">
          ...
          <!-- Projects Section-->
          <section class="projects no-padding-top" style="display: none;">
            <div class="container-fluid">
              <!-- Project-->
              <div class="project">
                <div class="row bg-white has-shadow">
          ...
          <!-- Client Section-->
          <section class="client no-padding-top" style="display: none;">
            <div class="container-fluid">
              <div class="row">
                <!-- Work Amount  -->
                <div class="col-lg-4">
          ...
          <!-- Feeds Section-->
          <section class="feeds no-padding-top" style="display: none;">
            <div class="container-fluid">
              <div class="row">
                <!-- Trending Articles-->
                <div class="col-lg-6">
